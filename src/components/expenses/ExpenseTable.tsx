...
function ActionButtons({ canDelete, expense, onDelete, onEdit, onView }: { canDelete: boolean; expense: ExpenseRecord; onDelete: () => void; onEdit: () => void; onView: () => void }) {
